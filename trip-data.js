...
window.TRIP = {
  ...
  stops: [
    ...
    { id:"d1-baankang",    day:1, time:"13:00", title:"Baan Kang Wat 藝術村",        titleEn:"Baan Kang Wat Artist Village",              kind:"景點 · Village",   grab:80,  coords:[18.7691, 98.9404] },
    { id:"d1-no39",        day:1, time:"15:00", title:"No.39 Café",                  titleEn:"Lakeside Treehouse Café",                   kind:"咖啡 · Café",      grab:0,   coords:[18.7066, 98.9189] },
    { id:"d1-graph",       day:1, time:"16:30", title:"GRAPH Contemporary",          titleEn:"Riverside Coffee & Gallery",                kind:"藝廊 · Gallery",   grab:120, coords:[18.7846, 99.0023] },
    ...
    // ───── Day 2 ─────
    { id:"d2-kaomai",      day:2, time:"08:10", title:"Kaomai Lanna Resort",         titleEn:"UNESCO Heritage Tobacco Barns",             kind:"建築 · Heritage",  grab:450, coords:[18.6300, 98.8900] },
    { id:"d2-rongbom",     day:2, time:"10:00", title:"Café Rong Bom",               titleEn:"Tobacco Barn Café",                         kind:"咖啡 · Café",      grab:0,   coords:[18.6308, 98.8895] },
    { id:"d2-taocha",      day:2, time:"11:00", title:"Tao Cha 茶屋",                 titleEn:"Tao Cha Tea House",                         kind:"茶 · Tea",         grab:0,   coords:[18.6296, 98.8906] },
    { id:"d2-kaomai-lunch",day:2, time:"12:00", title:"Kaomai 餐廳午餐",              titleEn:"Lunch at Kaomai",                           kind:"用餐 · Lunch",     grab:0,   coords:[18.6302, 98.8902] },
    { id:"d2-weave",       day:2, time:"15:00", title:"Weave Artisan Society",       titleEn:"Reclaimed Ice Factory · Artisans",          kind:"工藝 · Artisan",   grab:530, coords:[18.7046, 98.9430] },
    { id:"d2-huenphen",    day:2, time:"19:00", title:"Huen Phen Nimman 員工聚餐",   titleEn:"Studio Dinner · Northern Thai",             kind:"聚餐 · Dinner",    grab:0, highlight:true, coords:[18.8009, 98.9676] },
    { id:"d2-wualai",      day:2, time:"21:00", title:"Wualai 銀器街夜間散步",        titleEn:"Wualai Silver Lane Walk",                   kind:"夜間 · Night",     grab:70,  coords:[18.7790, 98.9893] },

    // ───── Day 3 ─────
    { id:"d3-maiiam",      day:3, time:"10:00", title:"MAIIAM 當代美術館",            titleEn:"MAIIAM Contemporary Art Museum",            kind:"美術館 · Museum",  grab:220, coords:[18.7746, 99.0689] },
    { id:"d3-sankamphaeng",day:3, time:"14:00", title:"San Kamphaeng 手工藝街",       titleEn:"San Kamphaeng Craft Street",                kind:"工藝 · Craft",     grab:80,  coords:[18.7475, 99.1208] },
    { id:"d3-watumong",    day:3, time:"15:30", title:"Wat Umong 地下隧道森林廟",     titleEn:"Forest Tunnel Temple",                      kind:"寺廟 · Temple",    grab:150, coords:[18.7763, 98.9484] },
    { id:"d3-sense-spa",   day:3, time:"17:00", title:"Sense Massage & Spa Nimman",   titleEn:"Sense Spa · Nimman",                        kind:"SPA · Spa",        grab:80, spa:"sense", coords:[18.7979, 98.9692] },

    // ───── Day 4 ─────
    { id:"d4-phalat",      day:4, time:"07:00", title:"Wat Pha Lat 叢林秘境寺廟",     titleEn:"Misty Jungle Temple",                       kind:"晨拍 · Sunrise",   grab:100, coords:[18.7993, 98.9326] },
    { id:"d4-maya",        day:4, time:"10:00", title:"MAYA Lifestyle Mall",          titleEn:"MAYA Mall · Cool-Down Day",                 kind:"購物 · Shopping",  grab:0,   coords:[18.8009, 98.9669] },
    { id:"d4-wualai-mkt",  day:4, time:"18:00", title:"Wualai 週六銀器夜市",          titleEn:"Saturday Walking Street",                   kind:"夜市 · Market",    grab:70,  coords:[18.7800, 98.9885] },
